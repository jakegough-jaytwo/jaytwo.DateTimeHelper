...
namespace jaytwo.DateTimeHelper.Tests
{
    public class DateTimeExtensionsTests
    {
        ...
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 8);
        ...
        public void SubtractHours()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 8, 23, 0, 0);
        ...
        public void SubtractMilliseconds()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 8, 23, 59, 59, 999);
        ...
        public void SubtractMinutes()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 8, 23, 59, 0);
        ...
        public void SubtractMonths()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 5, 9);
        ...
        public void SubtractSeconds()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 8, 23, 59, 59);
        ...
        public void SubtractWeekdays()
        {
            // arrange
            var date = new DateTime(2020, 6, 9);
            var expected = new DateTime(2020, 6, 2);
